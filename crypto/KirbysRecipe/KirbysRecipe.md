...
`U After tasting the soup, she knew she had to learn how to make it. She spent many weeks in the village, learning from the locals and perfecting her own recipe. When she returned home, she added her own special touches to the recipe, making it even more delicious.`<br><br>
**7. Base64**<br><br>
...
**9.** For this last cipher, we can use two different methods:<br><br>
